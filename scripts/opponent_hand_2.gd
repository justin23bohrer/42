...
func update_hand_position():
	...
	var column_x = get_viewport().size.x - 80  # Starting X position on the right side
	...
	for i in range(total):
		...
		var x_pos = column_x - column * column_spacing  # Adjust the X position for the right side
